...
class OrderTest {
	...
	@BeforeEach
	void setup() {
		this.order = new Order(100, "Amazonbook", 55.0);
	}
	...
	void Should_ReturnTrue_When_ItemNameMatches() {
		...
		//then
		assertEquals("Amazonbook", testItemName);
